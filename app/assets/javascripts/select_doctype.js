...
=======
    var select_doctype = {
      //todo - this would be nicer as a case statement with a regex pattern to match against, instead of repeating the url parts each time.
      getAssetType: function(data, assetType) {
        var totalDocTypes;
        if (assetType == 'http://definitions.artic.edu/ontology/1.0/type/StillImage') {
          totalDocTypes = data.asset_types.StillImage.doctypes;
      ...
      documentSubType: function(model, term, option) {
        var html =
>>>>>>> 3b93e24... fixes for subtypes and second subtypes
